...
For more color palettes, here are a few recommendations:

- Brewer and Viridis palettes are available in ggplot2 by default
- [Emil Hvitfeld's **r-color-palettes**](https://github.com/EmilHvitfeldt/r-color-palettes) (Meta collection)
- [Fabio Crameri's **scico**](https://github.com/thomasp85/scico) (Scientific and color blind friendly)
