...
import_plex <- function() {
  ...
  font_add(
    family = "ibmplexsans-300-light",
    file.path(font_dir, "IBMPlexSans-Light.ttf")
  )
  font_add(
    family = "ibmplexsans-300-lightitalic",
    file.path(font_dir, "IBMPlexSans-LightItalic.ttf")
  )
  font_add(
    family = "ibmplexsans-400-regular",
    file.path(font_dir, "IBMPlexSans-Regular.ttf")
  )
  font_add(
    family = "ibmplexsans-400-regularitalic",
    file.path(font_dir, "IBMPlexSans-Italic.ttf")
  )
  font_add(
    family = "ibmplexsans-500-medium",
    file.path(font_dir, "IBMPlexSans-Medium.ttf")
  )
  font_add(
    family = "ibmplexsans-500-mediumitalic",
    file.path(font_dir, "IBMPlexSans-MediumItalic.ttf")
  )
  font_add(
    family = "ibmplexsans-600-semibold",
    file.path(font_dir, "IBMPlexSans-SemiBold.ttf")
  )
  font_add(
    family = "ibmplexsans-600-semibolditalic",
    file.path(font_dir, "IBMPlexSans-SemiBoldItalic.ttf")
  )
  font_add(
    family = "ibmplexsans-700-bold",
    file.path(font_dir, "IBMPlexSans-Bold.ttf")
  )
  font_add(
    family = "ibmplexsans-700-bolditalic",
    file.path(font_dir, "IBMPlexSans-BoldItalic.ttf")
  )
}
